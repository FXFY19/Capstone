...
?>
    ...
    <br>
    <div class = "image1">
        <img src = "imgs/ReadMTG.jpg" alt = "How to read MTG Card">
    </div>

    <div class = "image">
        <img src = "imgs/MTGCardID2.jpg" alt = "MTG Display of Color Idenity"   >
    </div>
    <br>
    ...
    <div class = "down">
        ...
        <br>
        MTG Card Rarity: <input list = 'rarity' name = 'MTG_Card_Rarity'>
        <datalist id = 'rarity'>
            <option value = 'Common (Black)'>
            <option value = 'Uncommon (Grey)'>
            <option value = 'Rare (Gold)'>
            <option value = 'Mythic Rare (Orange)'>
        </datalist>
        <br>
