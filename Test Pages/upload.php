...
?>
    ...
    <body>
        ...
        <h4>Select Card Game You want to upload. </h4>
        <form action = "upload.php" method = "get">
            Card Game: <input list = "Card Games" name = "cardgame">
            <datalist id = "Card Games">
                <option value = "Magic the Gathering (MTG)">
                <option value = "Cardfight Vanguard (CFV)">
            </datalist>
            
        </form>
        <br>
        <?php 
            if ( $_GET["cardgame"] == "Magic the Gathering (MTG)"){
                echo "<h3> MTG Card Selected </h3>";
                echo "<br>";
            ...
            if ($_GET["cardgame"] == "Cardfight Vanguard (CFV)"){
                echo "<h3> CFV Card Selected </h3>";
            }
        ?>
